...
export default {
  ...
  'banner_public.DeleteBanner': ['DELETE', '/api/banner/delete/{id}'],
  'banner_public.ListBanner': ['GET', '/api/banner/list'],
  'banner_public.UploadBanner': ['POST', '/api/banner/upload'],
  ...
  'message_auth.ListChatMessage': ['GET', '/api/message/chat/list'],
  ...
  'sandpack_auth.CreateSandpack': ['POST', '/api/sandpack/create'],
  'sandpack_public.ListSandpack': ['GET', '/api/sandpack/list'],
